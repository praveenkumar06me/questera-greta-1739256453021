...
const menuItems = {
  coffee: [
    { id: 1, name: 'Espresso', price: 3.50, description: 'Rich and bold single shot' },
    { id: 2, name: 'Cappuccino', price: 4.50, description: 'Espresso with steamed milk and foam' },
    { id: 3, name: 'Latte', price: 4.50, description: 'Espresso with lots of steamed milk and light foam' },
    { id: 4, name: 'Mocha', price: 5.00, description: 'Espresso with chocolate and steamed milk' }
  ],
  pastries: [
    { id: 5, name: 'Croissant', price: 3.50, description: 'Buttery, flaky pastry' },
    { id: 6, name: 'Chocolate Muffin', price: 3.00, description: 'Rich chocolate muffin' },
    { id: 7, name: 'Cinnamon Roll', price: 4.00, description: 'Fresh baked with cream cheese frosting' },
    { id: 8, name: 'Apple Danish', price: 3.75, description: 'Flaky pastry with fresh apple filling' }
  ]
};
